        ...
        while True:
            try:
                ...
                if self.board[destination_x_WK][destination_y_WK] == '.':
                    ...
                    if (abs(self.position_x_WK - destination_x_WK) < 2 and abs(
                            self.position_y_WK - destination_y_WK) < 2):
        ...
        while True:
            try:
                ...
                if self.board[destination_x_WQ][destination_y_WQ] == '.':
                    ...
                    if (destination_x_WQ == self.position_x_WQ or destination_y_WQ == self.position_y_WQ or abs(
                            self.position_x_WQ - destination_x_WQ) == abs(self.position_y_WQ - destination_y_WQ)):
        ...
        while True:
            try:
                ...
                if self.board[destination_x_WKN][destination_y_WKN] == '.':
                    ...
                    if abs(self.position_x_WKN - destination_x_WKN) ** 2 + abs(
                            self.position_y_WKN - destination_y_WKN) ** 2 == 5:
